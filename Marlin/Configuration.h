...
#define STRING_CONFIG_H_AUTHOR "(Michal Madera, Anastazie)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anastazie"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "42ff1db0-4fab-4400-add6-8f009af046cf"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 123.85
  #define DEFAULT_bedKi 23.06
  #define DEFAULT_bedKd 443.47
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 142.86 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_BED_SIZE / 2), (Y_MIN_POS + 1), 20 }
